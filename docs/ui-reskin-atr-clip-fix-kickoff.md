...
**Status (2026-06-12): SUPERSEDED by `docs/ui-reskin-consolidated-fix-kickoff.md`** (this fix is its item 1a; the snapshot review found four siblings of the same pixel-budget disease). Do not route this doc.
