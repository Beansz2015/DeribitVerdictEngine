...
**Last updated: 2026-05-17 | Current version: settings.json v30 — display polish pass on top of v29 (auto-tweaker fixed window), v28 (target-hit metric toggle), v27 (OHLC gap-backfill).**
