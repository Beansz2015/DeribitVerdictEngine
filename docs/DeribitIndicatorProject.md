...
**Last updated: 2026-05-11 | Current version: settings.json v25 — output-dump feature. Bundle 3 d1 trend structure + d2 volume-weighted pivots. Bundle 1 (csv-expansion-v0.4 + analysis script) and Bundle 2 (auto-tweaker pipeline) shipped 2026-05-05 / 2026-05-06.**
