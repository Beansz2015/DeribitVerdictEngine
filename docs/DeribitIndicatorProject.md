...
**Last updated: 2026-05-12 | Current version: settings.json v25 — output-dump feature. Settings-snapshot-history bundle layered on top of Bundle 2 (auto-tweaker) and Bundle 3 (d1 trend structure + d2 volume-weighted pivots). Bundle 1 (csv-expansion-v0.4 + analysis script) shipped 2026-05-05.**
