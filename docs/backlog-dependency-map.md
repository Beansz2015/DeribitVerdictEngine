...
| **E5 / #6 absorption activation** ⚠ | ~~Trader ticks **Path B**~~ → **mechanism spec** → ~1–1.5 wk re-collection → re-derive → *then* the gates. ⚠ **The head edge is spent — the tick is no longer what blocks this.** The mechanism spec is | Absorption Step-2 penalty wire-in | queue §0a · [`absorption-anchor-rederivation-2026-07-30.md`](absorption-anchor-rederivation-2026-07-30.md) |
| ~~**F3 watch** (B4b trigger)~~ | ~~A tooling decision~~ ✅ **RETIRED 2026-08-12 — the edge is gone, nothing blocks and nothing unblocks.** ⛔ No cap-bucket segmentation is owed. ⚠ **B4b F3 only** — the 2026-07-02 audit-fixes F3 (EXIT GUARD strip) is a **different watch** and is **not** retired | — | queue §0a · [`w6-1-london-ruling-2026-07-31.md`](w6-1-london-ruling-2026-07-31.md) §3 |
| **C1-coverage F2** — split-hour capture-state flip | ~~A **spec question**~~ ✅ **RULED 2026-08-12 — split the hour at the marker; defective if EITHER part is.** The decision edge is spent; **an implementer slot is what remains** | A coverage report that cannot under-report a flip hour | queue §0a (decision text) · §2 (build slot) · [`c1-session1-review-2026-08-04.md`](c1-session1-review-2026-08-04.md) |
