...
**Date:** 2026-07-17 · **Status:** PROPOSED (trader-directed: "target side should score against actual placed targets… a comprehensive analysis of what has actually happened") · **Type:** offline-analysis semantics — zero scoring impact, no ⚠ boundary, no settings keys.
