...
| 5 | Doc re-ranker | finding which doc answers a question; main query "where was this decided?" | Continuous; judged on whether it speeds the seat up. ✅ **RULED 2026-09-23 (UTC), trader: built and in trial counts as closed**, because only sessions of real use can judge it. Plan: [`doc-reranker-measurement-plan.md`](doc-reranker-measurement-plan.md) |
| 6 | Decision-bias tripwire (added 2026-09-23, trader-agreed) | a recommendation that is cheaper AND less truthful than an available option (`CLAUDE.md` "The measured bias") | A retrospective measurement over the trader-ruled D-tables, scored against the rulings. The seat writes the shape baseline; the implementer never does (this file's §4c). ✅ **Piloted 2026-09-23:** [`harness-runs/decision-bias-pilot-run-2026-09-23.md`](harness-runs/decision-bias-pilot-run-2026-09-23.md). Armed for new decisions, on the go |
