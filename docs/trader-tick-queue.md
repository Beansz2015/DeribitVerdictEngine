...
| **D2** OBV `trend_gate` 18→~23 | trader — ⚠ boundary | Ready. Bundles with D1 **after** D1 is re-derived |
| **D3** ASIA `burst_ratio_threshold` = 5.5 | trader — ⚠ boundary | Ready, gate met (323 fires vs ~150). **Ships alone and first** |
