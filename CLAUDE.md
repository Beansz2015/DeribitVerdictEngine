...
1. **Read `docs/DeribitIndicatorProject.md`** in full (**80,999 tokens at 192,695 B, MEASURED 2026-09-11 (UTC)**; historical content lives in `docs/history-archive.md`). Touch the archive doc only if you need pre-v61 version history or pre-v27 settings rationale.
